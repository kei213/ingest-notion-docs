...
function processMarkDownFiles(directoryPath) {
    return __awaiter(this, void 0, void 0, function () {
        var fileNames, docs, _i, fileNames_1, fileName, filePath, text, metadata, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 6, , 7]);
                    return [4 /*yield*/, glob_1["default"]('**/*.md', { cwd: directoryPath })];
                case 1:
                    fileNames = _a.sent();
                ...
                case 2:
                    ...
                    filePath = path_1["default"].join(directoryPath, fileName);
